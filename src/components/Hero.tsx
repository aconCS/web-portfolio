export default function Hero() {
  return (
    <div className="flex flex-col-reverse md:flex-row gap-[24px] items-center justify-center shrink-0">
      ...
      <div className="flex flex-col items-start shrink-0 w-[586px] max-w-full">
        <div className="flex gap-[10px] items-center shrink-0">
          <p className="whitespace-nowrap">
            <span className="font-kanit font-extralight text-[16px] leading-[normal] text-primary-brown">based in </span>
            <span className="font-kanit font-medium text-[16px] leading-[normal] text-primary-brown">Maastricht, Limburg</span>
          </p>
        ...
        <div className="flex flex-wrap gap-[10px] items-center py-[5px]">
          ...
          >
            ...
            <span className="font-kanit font-light text-[20px] text-primary-brown leading-[normal]">Book meeting</span>
          </a>
          <a
            href="mailto:2005acon@gmail.com"
            className="flex items-center gap-[5px] hover:opacity-70 transition-opacity"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-primary-brown shrink-0">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <polyline points="22,6 12,13 2,6" />
            </svg>
            <span className="font-kanit font-light text-[20px] text-primary-brown leading-[normal]">2005acon@gmail.com</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-kanit font-light text-[20px] text-primary-brown leading-[normal]">linkedin</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-kanit font-light text-[20px] text-primary-brown leading-[normal]">github</span>
          </a>
        </div>
      </div>
    </div>
