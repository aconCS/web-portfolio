  ...
  return (
    <div className="flex flex-1 items-center justify-center min-w-0">
      <div className="flex gap-[50px] items-center">
        <div className="flex flex-col gap-[10px] items-start whitespace-nowrap">
          <div className="flex flex-col text-primary-brown">
            <p className="font-hitmo font-black text-[36px] leading-[normal] mb-0">Maastricht University</p>
            <p className="font-hitmo font-black text-[20px] leading-[normal]">BSc Computer Science</p>
          </div>
        ...
        <div className="relative text-primary-brown">
          <p className="font-hitmo font-black text-[36px] leading-[normal] mb-6">Relevant Skills Developed:</p>
